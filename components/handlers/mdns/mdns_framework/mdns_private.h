...
#define MDNS_SERVICE_STACK_DEPTH    4096
#define MDNS_TASK_PRIORITY          1
...
#endif
#define MDNS_TASK_AFFINITY          0x1
#define MDNS_SERVICE_ADD_TIMEOUT_MS 2000
...
#define MDNS_TIMER_PERIOD_US        (100*1000)
...
#define HOOK_MALLOC_FAILED  ESP_LOGE(TAG, "Cannot allocate memory");
#endif
